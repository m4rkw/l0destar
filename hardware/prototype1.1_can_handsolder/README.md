# l0destar v1.1 prototype - CAN version
...
It features:
 ...
 - 5V buck to power the MIKROE-2379
...
| [10K resistor](https://amzn.to/4gc8ZvK)                                                | 10       |
| [56K resistor](https://amzn.to/4gc8ZvK)                                                | 2        |
| [100K resistor](https://amzn.to/4gc8ZvK)                                               | 7        |
| [MOSFET - ZVN4206A](https://amzn.to/3S775mb)                                           | 5        |
| [TVS Diode - P6KE24CA](https://amzn.to/4aLxvAd)                                        | 2        |
...
- If you don't care about CAN the Mikroe board can be omitted
...
- The MIKROE-2379 was the quick and obvious option for a CAN-FD interface but
  it's vehicle-side connector isn't ideal. I've left the Molex receptable as a
  6-pin so there's space for CAN-H and CAN-L to be added, will have a hunt
  around for a better CAN breakout when I have time
