...
### Accelerometer never sleeps (NC pins grounded)

Present in v3.0 - v3.3. The ASM330LHHXTR symbol had pins 10 and 11, which
the datasheet marks NC, as hidden pins stacked on the GND pin, so the layout
tied both pads to the ground pour. With those pins grounded the part never
enters its low-power state and keeps drawing current the whole time the board
is asleep. Fixed here by making pins 10 and 11 proper no-connect pins in the
...
[v3.2 README](../l0destar_v3.2/README.md#known-defects). Fixed in v3.3 by S10U2
...
- Fixed the ASM330LHHXTR accelerometer symbol. Pins 10 and 11 are NC on the
  datasheet but the symbol had them as hidden pins on the GND pin, so they
...
| S15L1 | RF inductor | 0603 47-68 nH, SRF > 2GHz | [LQW18AN68NJ00D](https://uk.farnell.com/murata/lqw18an68nj00d/inductor-68nh-2-2ghz-0-34a-0603/dp/3471533) | |
...
| S9U1 | TCAN3414DR CAN transceiver | TCAN3414DR | [TCAN3414DR](https://www.digikey.co.uk/en/products/detail/texas-instruments/TCAN3414DR/22147393) | |
...
Can be omitted if K-wire is not required
...
| All | RF inductor | 1 | 0603 47-68 nH, SRF > 2GHz | [LQW18AN68NJ00D](https://uk.farnell.com/murata/lqw18an68nj00d/inductor-68nh-2-2ghz-0-34a-0603/dp/3471533) | |
...
| CAN | TCAN3414DR CAN transceiver | 1 | TCAN3414DR | [TCAN3414DR](https://www.digikey.co.uk/en/products/detail/texas-instruments/TCAN3414DR/22147393) | |
...
| K-wire | 47K resistor | 2 | 0402 47K 5% | [ERJ2RKF4702X](https://uk.farnell.com/panasonic/erj2rkf4702x/res-47k-1-0-1w-0402-thick-film/dp/2302806) | |
...
| K-wire | 1M 0402 anti-sulfur resistor | 1 | 0402 1M 1% ANTI-SULFUR AEC-Q200 | [AF0402FR-071ML](https://uk.farnell.com/yageo/af0402fr-071ml/res-1m-1-0-063w-thick-film-0402/dp/4148383) | anti-sulfur recommended, not critical |
...
| K-wire | 2.2uF 0603 capacitor | 1 | 0603 >= 25V 10% X7R | [GRM188Z71E225KE43D](https://uk.farnell.com/murata/grm188z71e225ke43d/cap-mlcc-2-2uf-x7r-25v-0603/dp/4335731) | |
| K-wire | MOSFET | 2 | 2N7002 SOT-23 | [2N7002](https://uk.farnell.com/multicomp-pro/2n7002/mosfet-n-ch-60v-0-115a-sot-23/dp/4295174) | |
| K-wire | 1N4148W diode | 3 | 1N4148W | [1N4148W-E3-08](https://uk.farnell.com/vishay/1n4148w-e3-08/diode-switching-100v-sod-123/dp/2433353) | |
