...
**On Linux on arm64**, install it the way the [prerequisites](prerequisites.md#nrf-connect-sdk) install v3.3.0, with the Zephyr SDK that v3.4.0 needs, 1.0.1. It takes about another 4.5GB:
