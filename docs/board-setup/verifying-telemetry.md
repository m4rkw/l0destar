...
| `no GPS fix`, or `reporting from last known position` | No usable GNSS signal. | Active antenna on the GNSS connector, a view of the sky, and patience: an unassisted first fix takes 2 to 5 minutes. |
