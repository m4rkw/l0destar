...
3. Once the tracker has gone to sleep, a minute or so after switching off, get in and close the door firmly or rock the vehicle on its suspension. A movement or parked impact alert should arrive - at priority 2 unless you have changed it, so set up notifications first (see [Configure alerts](alerts.md)). A single light knock may be ignored as a transient bump.
